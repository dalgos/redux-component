...
const SelectBox = __webpack_require__(320);

let container = document.createElement('div');

let sbox = new SelectBox(container);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__overArg_js__ = __webpack_require__(308);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__freeGlobal_js__ = __webpack_require__(304);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(59), __webpack_require__(319)(module)))
...
const iView = __webpack_require__(322);
const selectboxStore = __webpack_require__(324);

class SelectBox extends iView {
  constructor(props, context) {
    super(props, context);
    this.sbox = document.createElement('select');
    this.sbox.addEventListener('change', this.clickHandler);
    props.appendChild(this.sbox);
    console.log(props);
  }
  clickHandler(evt) {
    console.log('click');
...
const BOX_CLICK = 'BOX_CLICK';
/* harmony export (immutable) */ __webpack_exports__["BOX_CLICK"] = BOX_CLICK;
...
const { BOX_CLICK } = __webpack_require__(321);
...
function selectbox(state = initialState, action) {
  switch (action.type) {
    case BOX_CLICK:
      return [{
        value: 'opt2',
...
const { createStore } = __webpack_require__(314);
const selectboxReducer = __webpack_require__(323);

module.exports = createStore(selectboxReducer);
...
const app = __webpack_require__(121);
