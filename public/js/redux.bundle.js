...
var dr = __webpack_require__(52);
var initialState = {
  count: 0,
  images: ['https://camo.githubusercontent.com/f28b5bc7822f1b7bb28a96d8d09e7d79169248fc/687474703a2f2f692e696d6775722e636f6d2f4a65567164514d2e706e67', 'https://camo.githubusercontent.com/f28b5bc7822f1b7bb28a96d8d09e7d79169248fc/687474703a2f2f692e696d6775722e636f6d2f4a65567164514d2e706e67']
};

var dealDetailReducers = __webpack_require__(56);
var store = createStore(combineReducers(dealDetailReducers), initialState);

var CounterM = __webpack_require__(30);
var Images = __webpack_require__(54);

dr(function () {
  var counter = new CounterM({ initialStore: store, container: document.querySelector('#counter') });
  var images = new Images({ initialStore: store, container: document.querySelector('#images') });
});
...
// });
// 
var DealDetail = __webpack_require__(7);
...
var CounterM = function (_Counter) {
  _inherits(CounterM, _Counter);

  function CounterM() {
    _classCallCheck(this, CounterM);

    return _possibleConstructorReturn(this, (CounterM.__proto__ || Object.getPrototypeOf(CounterM)).apply(this, arguments));
  }

  _createClass(CounterM, [{
    key: 'initialRender',
    value: function initialRender() {
      ...
      this.dispatcher.on('click', function (evt) {
...
var BaseComponent = function () {
  function BaseComponent() {
    ...
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        initialStore = _ref$initialStore === undefined ? null : _ref$initialStore,
    ...
    if (this.__store) {
      this.__store.subscribe(function () {
        _this.render();
      });
    }
    this.initialRender();
...
var BaseComponent = __webpack_require__(31);

var Counter = function (_BaseComponent) {
  _inherits(Counter, _BaseComponent);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<ul>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.images : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</ul>";
...
var BaseComponent = __webpack_require__(31);
var tmpl = __webpack_require__(53);
var $ = __webpack_require__(51);

var Images = function (_BaseComponent) {
  _inherits(Images, _BaseComponent);
